...
public class EventService
{
    ...
    {
        var sql = "SELECT * FROM get_events_by_username(@p0)";
    ...
    {
        var sql = "SELECT join_event_by_code(@p0, @p1)";
        return await _context.Database
    ...
    {
        var sql = "SELECT leave_event(@p0, @p1)";
        return await _context.Database
    ...
    {
        var sql = "SELECT * FROM view_upcoming_events_detailed";
        return await _context.Database
    ...
    {
        var sql = "SELECT * FROM filter_events_by_distance(@p0, @p1)";
        return await _context.Database
    ...
    {
        var sql = "SELECT * FROM get_all_destinations_for_event(@p0)";
        return await _context.Database
